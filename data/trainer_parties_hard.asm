...
BikerData: ; COMPLETED
	...
	db "LOGAN@",54,HOUNDOOM,TYRANITAR,$FF ; Cyclingroad 4
...
BirdKeeperData: ; COMPLETED
	...
	db "ABE@",53,FEAROW,PIDGEOTTO,PIDGEOT,FEAROW,MURKROW,$FF  ;             UNKNOWN
...
BlackbeltData: ; COMPLETED
	db "KENJI@",50,HITMONTOP,HITMONLEE,HITMONCHAN,$FF ; Blackbelt leader
...
ScientistData: ; COMPLETED
	...
	db "HOWIE@",47,TYRANITAR,DRAGONITE,$FF ; SILPHCO 8 T
