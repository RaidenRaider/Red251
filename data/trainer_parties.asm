...
BrockData:
	...
	db 12,ZUBAT
	moveset SUPERSONIC, GUST, BITE, WING_ATTACK
	
	db 12,GEODUDE
	moveset TACKLE, DEFENSE_CURL, HARDEN, ROCK_POLISH
...
MistyData:
	...
	db 16,GOLDEEN
	moveset SUPERSONIC, HORN_ATTACK, QUICK_ATTACK, WATER_PULSE
	
	db 18,POLIWAG
	moveset WATER_GUN, HYPNOSIS, BUBBLE, DOUBLESLAP
...
LtSurgeData:
	...
	db 20,MAGNETON
	moveset THUNDERSHOCK, SONICBOOM, QUICK_ATTACK, THUNDERBOLT
	
	db 18,PIKACHU
	moveset THUNDERBOLT, THUNDER_WAVE, QUICK_ATTACK, DOUBLE_TEAM
	
	db 22,ELECTRODE
	moveset QUICK_ATTACK, THUNDERBOLT, SWIFT, SELFDESTRUCT
...
ErikaData:
	...
	db 26,STANTLER
	moveset RAGE, HEADBUTT, STOMP, ZEN_HEADBUTT
	
	db 31,SCYTHER
	moveset QUICK_ATTACK, AGILITY, SLASH, METAL_CLAW
	db $FF
...
KogaData:
	...
	db 41,SUDOWOODO
	moveset QUICK_ATTACK, MIRROR_MOVE, SLEEP_POWDER, RAZOR_LEAF
...
BlaineData:
	...
	db 46,NINETALES
	moveset QUICK_ATTACK, FEINT_ATTACK, FLAMETHROWER, FIRE_BLAST
...
SabrinaData:
	...
	db 42,GIRAFARIG
	moveset QUICK_ATTACK, SWIFT, ANCIENTPOWER, PSYBEAM
	
	db 43,ALAKAZAM
	moveset SHADOW_BALL, RECOVER, PSYWAVE, REFLECT
	
	db 45,JYNX
	moveset DOUBLESLAP, DRAININGKISS, SING, PSYCHIC
	db $FF
...
GiovanniData:
	...
	db 48,URSARING
	moveset BITE, MEGA_PUNCH, TAKE_DOWN, EARTHQUAKE
	
	db 50,TYRANITAR
	moveset STOMP, CRUNCH, EARTHQUAKE, THRASH
	db $FF
...
LoreleiData:
	...
	db 53,CORSOLA
	moveset WATER_GUN, WATER_PULSE, ICE_BEAM, HYDRO_PUMP
...
BrunoData:
	...
	db 55,HITMONTOP
	moveset ROLLING_KICK, DOUBLE_KICK, FEINT_ATTACK, MEGA_KICK
...
AgathaData:
	...
	db 56,MURKROW
	moveset WING_ATTACK, NIGHT_SHADE, HEX, NIGHT_SLASH	
	
	db 59,SKARMORY
	moveset AIR_CUTTER, SWIFT, AIR_SLASH, NIGHT_SLASH
...
LanceData:
	...
	db 61,FERALIGATR
	moveset WATER_PULSE, SKULL_BASH, HYDRO_PUMP, HYDRO_CANNON 
...
BlackbeltData:
	db "KENJI@",37,HITMONTOP,HITMONLEE,HITMONCHAN,$FF
...
PkmnTrainerData:
	...
	db 36,TYRANITAR
	moveset QUICK_ATTACK, ROCK_SLIDE, ICE_FANG, STOMP
	db $FF
