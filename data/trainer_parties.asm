...
BrockData:
	db "BROCK@",$FF,12,ZUBAT,12,GEODUDE,14,ONIX,0
	
MistyData:
	db "MISTY@",$FF,18,STARYU,16,GOLDEEN,18,POLIWAG,21,STARMIE,0
	
LtSurgeData:
	db "LT.SURGE@",$FF,21,VOLTORB,20,MAGNETON,18,PIKACHU,22,ELECTRODE,24,RAICHU,0
	
ErikaData:
	db "ERIKA@",$FF,29,VICTREEBEL,24,TANGELA,29,BELLOSSOM,26,STANTLER,31,SCYTHER,0
	
KogaData:
	db "KOGA@",$FF,37,VENOMOTH,39,MUK,37,CROBAT,41,SUDOWOODO,43,WEEZING,0
	
BlaineData:
	db "BLAINE@",$FF,42,GROWLITHE,40,PONYTA,42,RAPIDASH,45,ARCANINE,46,NINETALES,47,MAGMAR,0
	
SabrinaData:
	db "SABRINA@",$FF,38,KADABRA,37,MR_MIME,38,ESPEON,42,GIRAFARIG,43,ALAKAZAM,45,JYNX,0
	
GiovanniData:
	db "GIOVANNI@",$FF,25,ONIX,24,RHYHORN,29,KANGASKHAN,0
	db "GIOVANNI@",$FF,35,ONIX,37,RHYHORN,37,NIDORINO,41,NIDOQUEEN,0
	db "GIOVANNI@",$FF,45,RHYDON,42,STEELIX,44,NIDOQUEEN,45,NIDOKING,48,URSARING,50,TYRANITAR,0
	
LoreleiData:
	db "LORELEI@",$FF,53,CORSOLA,54,DEWGONG,53,CLOYSTER,54,SLOWKING,56,JYNX,56,LAPRAS,0
	
BrunoData:
	db "BRUNO@",$FF,53,ONIX,55,HITMONTOP,55,HITMONCHAN,55,HITMONLEE,56,STEELIX,58,MACHAMP,0
	
AgathaData:
	db "AGATHA@",$FF,56,MISDREAVUS,56,HAUNTER,55,HOUNDOOM,56,MURKROW,59,SKARMORY,60,GENGAR,0
	
LanceData:
	db "LANCE@",$FF,58,GYARADOS,56,CHARIZARD,56,KINGDRA,60,AERODACTYL,61,FERALIGATR,62,DRAGONITE,0
...
BlackbeltData:
	db "KENJI@",37,HITMONTOP,HITMONLEE,HITMONCHAN,0
...
PkmnTrainerData:
    db "FLANNERY@",$FE,FLANNERY,COOLTRAINER_F,33,SLUGMA,33,SLUGMA,36,TYRANITAR,0
